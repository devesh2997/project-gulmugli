 ...
 * The component alternates between speaking.mouth and this for lip-sync effect.
 */
...
export const pixelFaces: Record<string, FaceState> = {
  ...
  thinking: {
    left_brow: [
      { x: 7, y: 8, opacity: 0.8 },
      { x: 8, y: 7, opacity: 0.85 },
      { x: 9, y: 7, opacity: 0.85 },
      { x: 10, y: 7, opacity: 0.85 },
      { x: 11, y: 7, opacity: 0.85 },
      { x: 12, y: 8, opacity: 0.8 },
    ],
    right_brow: [
      { x: 19, y: 8, opacity: 0.8 },
      { x: 20, y: 7, opacity: 0.85 },
      { x: 21, y: 7, opacity: 0.85 },
      { x: 22, y: 7, opacity: 0.85 },
      { x: 23, y: 7, opacity: 0.85 },
      { x: 24, y: 8, opacity: 0.8 },
    ],
    left_eye: [
      { x: 8, y: 12, opacity: 0.85 }, { x: 9, y: 12, opacity: 0.85 },
      { x: 10, y: 12, opacity: 0.85 }, { x: 11, y: 12, opacity: 0.85 },
      { x: 8, y: 13, opacity: 0.75 }, { x: 9, y: 13, opacity: 0.75 },
      { x: 10, y: 13, opacity: 0.75 }, { x: 11, y: 13, opacity: 0.75 },
      { x: 8, y: 14, opacity: 0.6 }, { x: 9, y: 14, opacity: 0.6 },
      { x: 10, y: 14, opacity: 0.6 }, { x: 11, y: 14, opacity: 0.6 },
    ],
    right_eye: [
      { x: 20, y: 12, opacity: 0.85 }, { x: 21, y: 12, opacity: 0.85 },
      { x: 22, y: 12, opacity: 0.85 }, { x: 23, y: 12, opacity: 0.85 },
      { x: 20, y: 13, opacity: 0.75 }, { x: 21, y: 13, opacity: 0.75 },
      { x: 22, y: 13, opacity: 0.75 }, { x: 23, y: 13, opacity: 0.75 },
    ...
    mouth: [
      { x: 14, y: 22, opacity: 0.6 },
      { x: 15, y: 21, opacity: 0.7 }, { x: 16, y: 21, opacity: 0.7 },
      { x: 17, y: 22, opacity: 0.6 },
      { x: 15, y: 23, opacity: 0.6 }, { x: 16, y: 23, opacity: 0.6 },
    ],
  },

  listening: {
    left_brow: [
      { x: 8, y: 8, opacity: 0.75 },
      { x: 9, y: 8, opacity: 0.8 },
      { x: 10, y: 8, opacity: 0.8 },
      { x: 11, y: 8, opacity: 0.75 },
    ],
    right_brow: [
      { x: 20, y: 8, opacity: 0.75 },
      { x: 21, y: 8, opacity: 0.8 },
      { x: 22, y: 8, opacity: 0.8 },
      { x: 23, y: 8, opacity: 0.75 },
    ],
    left_eye: [
      { x: 8, y: 12, opacity: 0.85 }, { x: 9, y: 12, opacity: 0.85 },
      { x: 10, y: 12, opacity: 0.85 }, { x: 11, y: 12, opacity: 0.85 },
      { x: 8, y: 13, opacity: 0.85 }, { x: 9, y: 13, opacity: 0.85 },
      { x: 10, y: 13, opacity: 0.85 }, { x: 11, y: 13, opacity: 0.85 },
      { x: 8, y: 14, opacity: 0.7 }, { x: 9, y: 14, opacity: 0.7 },
      { x: 10, y: 14, opacity: 0.7 }, { x: 11, y: 14, opacity: 0.7 },
    ],
    right_eye: [
      { x: 20, y: 12, opacity: 0.85 }, { x: 21, y: 12, opacity: 0.85 },
      { x: 22, y: 12, opacity: 0.85 }, { x: 23, y: 12, opacity: 0.85 },
      { x: 20, y: 13, opacity: 0.85 }, { x: 21, y: 13, opacity: 0.85 },
      { x: 22, y: 13, opacity: 0.85 }, { x: 23, y: 13, opacity: 0.85 },
      { x: 20, y: 14, opacity: 0.7 }, { x: 21, y: 14, opacity: 0.7 },
      { x: 22, y: 14, opacity: 0.7 }, { x: 23, y: 14, opacity: 0.7 },
    ],
    nose: [
      { x: 15, y: 17, opacity: 0.3 },
      { x: 16, y: 18, opacity: 0.3 },
    ],
    mouth: [
      { x: 13, y: 22, opacity: 0.6 }, { x: 14, y: 22, opacity: 0.6 },
      { x: 15, y: 22, opacity: 0.6 }, { x: 16, y: 22, opacity: 0.6 },
      { x: 17, y: 22, opacity: 0.6 }, { x: 18, y: 22, opacity: 0.6 },
    ],
  },

  speaking: {
    left_brow: [
      { x: 7, y: 10, opacity: 0.65 },
      { x: 8, y: 9, opacity: 0.7 },
      { x: 9, y: 9, opacity: 0.75 },
      { x: 10, y: 9, opacity: 0.75 },
      { x: 11, y: 9, opacity: 0.7 },
      { x: 12, y: 10, opacity: 0.65 },
    ],
    right_brow: [
      { x: 19, y: 10, opacity: 0.65 },
      { x: 20, y: 9, opacity: 0.7 },
      { x: 21, y: 9, opacity: 0.75 },
      { x: 22, y: 9, opacity: 0.75 },
      { x: 23, y: 9, opacity: 0.7 },
      { x: 24, y: 10, opacity: 0.65 },
    ],
    left_eye: [
      { x: 8, y: 13, opacity: 0.85 }, { x: 9, y: 13, opacity: 0.85 },
      { x: 10, y: 13, opacity: 0.85 }, { x: 11, y: 13, opacity: 0.85 },
      { x: 8, y: 14, opacity: 0.65 }, { x: 9, y: 14, opacity: 0.65 },
      { x: 10, y: 14, opacity: 0.65 }, { x: 11, y: 14, opacity: 0.65 },
    ],
    right_eye: [
      { x: 20, y: 13, opacity: 0.85 }, { x: 21, y: 13, opacity: 0.85 },
      { x: 22, y: 13, opacity: 0.85 }, { x: 23, y: 13, opacity: 0.85 },
      { x: 20, y: 14, opacity: 0.65 }, { x: 21, y: 14, opacity: 0.65 },
      { x: 22, y: 14, opacity: 0.65 }, { x: 23, y: 14, opacity: 0.65 },
    ],
    nose: [
      { x: 15, y: 17, opacity: 0.25 },
      { x: 16, y: 18, opacity: 0.25 },
    ...
    mouth: [
      { x: 11, y: 22, opacity: 0.7 }, { x: 12, y: 22, opacity: 0.75 },
      { x: 13, y: 22, opacity: 0.75 }, { x: 14, y: 22, opacity: 0.75 },
      { x: 15, y: 22, opacity: 0.75 }, { x: 16, y: 22, opacity: 0.75 },
      { x: 17, y: 22, opacity: 0.75 }, { x: 18, y: 22, opacity: 0.75 },
      { x: 19, y: 22, opacity: 0.75 }, { x: 20, y: 22, opacity: 0.7 },
      { x: 12, y: 23, opacity: 0.6 }, { x: 13, y: 23, opacity: 0.6 },
      { x: 14, y: 23, opacity: 0.6 }, { x: 15, y: 23, opacity: 0.6 },
      { x: 16, y: 23, opacity: 0.6 }, { x: 17, y: 23, opacity: 0.6 },
      { x: 18, y: 23, opacity: 0.6 }, { x: 19, y: 23, opacity: 0.6 },
    ],
  },
