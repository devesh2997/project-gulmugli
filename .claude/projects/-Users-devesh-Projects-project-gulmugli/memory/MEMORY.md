...
- [project_dashboard_iteration.md](project_dashboard_iteration.md) — Current focus is UI/dashboard iteration, built by cowork
- [deferred_audio_training.md](deferred_audio_training.md) — Voice cloning pipeline built but Devesh hasn't recorded yet. Prompt him to run `check_audio_quality.py` BEFORE recording when he asks to "work on audio" or "voice training"
