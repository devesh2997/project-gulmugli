...
SETTINGS_SCHEMA: list[dict] = [
    ...
    # ── Sleep Mode ──
    {
        "path": "sleep_mode.turn_off_lights",
        "type": "bool",
        "label": "Turn off lights",
        "description": "Turn off lights when entering sleep mode",
        "restart": "none",
        "category": "sleep_mode",
    },
    {
        "path": "sleep_mode.play_sleep_music",
        "type": "bool",
        "label": "Play sleep music",
        "description": "Play soothing music when entering sleep mode",
        "restart": "none",
        "category": "sleep_mode",
    },
    {
        "path": "sleep_mode.sleep_music_query",
        "type": "string",
        "label": "Sleep music search",
        "description": "Search query for sleep music",
        "restart": "none",
        "category": "sleep_mode",
    },
    {
        "path": "sleep_mode.sleep_music_volume",
        "type": "int",
        "label": "Sleep music volume",
        "description": "Volume for sleep music (0-100)",
        "min": 0,
        "max": 100,
        "restart": "none",
        "category": "sleep_mode",
    ...
    {
        "path": "sleep_mode.duck_existing_music",
        "type": "bool",
        "label": "Duck existing music",
        "description": "Lower volume of currently playing music instead of stopping it",
        "restart": "none",
        "category": "sleep_mode",
    },
    {
        "path": "sleep_mode.restore_lights_on_wake",
        "type": "bool",
        "label": "Restore lights on wake",
        "description": "Turn lights back on when waking up",
        "restart": "none",
        "category": "sleep_mode",
    },
    {
        "path": "sleep_mode.restore_volume_on_wake",
        "type": "bool",
        "label": "Restore volume on wake",
        "description": "Restore music volume to pre-sleep level when waking up",
        "restart": "none",
        "category": "sleep_mode",
    },
    {
        "path": "sleep_mode.wake_lights_brightness",
        "type": "int",
        "label": "Wake brightness",
        "description": "Light brightness when waking up (0-100)",
        "min": 0,
        "max": 100,
        "restart": "none",
        "category": "sleep_mode",
